 ...
 * <p/>
 * <p>
 * For more information about this service, see the <a
 * href="https://developers.google.com/drive/" target="_blank">API
 * Documentation</a>
 * </p>
 * <p/>
 * <p>
 * This service uses {@link DriveRequestInitializer} to initialize global
 * parameters via its {@link Builder}.
 * </p>
 * <p/>
 * <p>
 * Upgrade warning: this class now extends {@link AbstractGoogleJsonClient},
 * whereas in prior version 1.8 it extended
 * {@link com.google.api.client.googleapis.services.GoogleClient}.
 * </p>
 *
 * @author Google, Inc.
 * @since 1.3
...
public class Drive extends AbstractGoogleJsonClient {
    ...
    public Drive(HttpTransport transport, JsonFactory jsonFactory,
        ...
        super(new Builder(transport, jsonFactory, httpRequestInitializer).setRootUrl(DEFAULT_ROOT_URL).
                setServicePath(DEFAULT_SERVICE_PATH).setSuppressAllChecks(true));
    }
     ...
     * @param applicationName                application name to be sent in the User-Agent header of
     *                                       requests or {@code null} for none
     * @param suppressPatternChecks          whether discovery pattern checks should be suppressed on
     *                                       required parameters
     */
    ...
    public class About {
         ...
         * <p/>
         * This request holds the parameters needed by the the drive server.
         * After setting any optional parameters, call the {@link Get#execute()}
        ...
        public class Get extends DriveRequest<com.google.api.services.drive.model.About> {
             ...
             * <p>
             * {@link Get#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
             * @since 1.13
             ...
             * include shared files and public files the user has opened. When
             * set to false, this counts only change IDs for owned files and any
             * shared or public files that the user has explictly added to a
             * folder in Drive.
             */
            ...
            /**
             * Convenience method that returns only {@link Boolean#TRUE} or
             * {@link Boolean#FALSE}.
             * <p/>
             * <p>
             * Boolean properties can have four possible values: {@code null},
             * {@link com.google.api.client.util.Data#NULL_BOOLEAN},
             * {@link Boolean#TRUE} or {@link Boolean#FALSE}.
             * </p>
             * <p/>
             * <p>
             * This method returns {@link Boolean#TRUE} if the default of the
             * property is {@link Boolean#TRUE} and it is {@code null} or
             * {@link com.google.api.client.util.Data#NULL_BOOLEAN}.
             * {@link Boolean#FALSE} is returned if the default of the property
             * is {@link Boolean#FALSE} and it is {@code null} or
             * {@link com.google.api.client.util.Data#NULL_BOOLEAN}.
             * </p>
             * <p/>
             * <p>
            ...
            public boolean isIncludeSubscribed() {
                if (includeSubscribed == null
                        || includeSubscribed == com.google.api.client.util.Data.NULL_BOOLEAN) {
                    return true;
                }
                return includeSubscribed;
            }
    ...
    public class Apps {
        ...
        public class List extends DriveRequest<com.google.api.services.drive.model.AppList> {
             ...
             * {@link List#execute()} method to invoke the remote operation.
             * <p>
             * {@link List#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
    ...
    public class Changes {
        ...
        public class Get extends DriveRequest<com.google.api.services.drive.model.Change> {
            ...
            protected Get(String changeId) {
                ...
                this.changeId = Preconditions.checkNotNull(changeId,
                        "Required parameter changeId must be specified.");
            }
        ...
        public class List extends DriveRequest<com.google.api.services.drive.model.ChangeList> {
             ...
             */
            protected List() {
                super(Drive.this, "GET", REST_PATH, null,
             ...
             * opened. When set to false, the list will include owned files plus
             * any shared or public files the user has explictly added to a
             * folder in Drive.
             */
            @com.google.api.client.util.Key
            private Boolean includeSubscribed;
    ...
    public class Children {
         ...
         * This request holds the parameters needed by the the drive server.
         * After setting any optional parameters, call the
         * {@link Delete#execute()} method to invoke the remote operation.
         *
        ...
        public class Delete extends DriveRequest<Void> {
             ...
             * {@link Delete#execute()} method to invoke the remote operation.
             * <p>
             * {@link Delete#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
            ...
            protected Delete(String folderId, String childId) {
                ...
                this.folderId = Preconditions.checkNotNull(folderId,
                        "Required parameter folderId must be specified.");
                this.childId = Preconditions.checkNotNull(childId,
                        "Required parameter childId must be specified.");
            }
         ...
         * @param folderId The ID of the folder.
         * @param content  the
         *                 {@link com.google.api.services.drive.model.ChildReference}
         * @return the request
         */
        public Insert insert(String folderId, com.google.api.services.drive.model.ChildReference content)
                throws java.io.IOException {
        ...
        public class Insert extends DriveRequest<com.google.api.services.drive.model.ChildReference> {
             ...
             * {@link Insert#execute()} method to invoke the remote operation.
             * <p>
             * {@link Insert#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
            ...
            protected Insert(String folderId, com.google.api.services.drive.model.ChildReference content) {
                super(Drive.this, "POST", REST_PATH, content,
                        com.google.api.services.drive.model.ChildReference.class);
                this.folderId = Preconditions.checkNotNull(folderId,
                        "Required parameter folderId must be specified.");
            }
    ...
    public class Comments {
        ...
        public class Delete extends DriveRequest<Void> {
            ...
            protected Delete(String fileId, String commentId) {
                ...
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
                this.commentId = Preconditions.checkNotNull(commentId,
                        "Required parameter commentId must be specified.");
            }
        ...
        public class Get extends DriveRequest<com.google.api.services.drive.model.Comment> {
            ...
            /**
             * If set, this will succeed when retrieving a deleted comment, and
             * will include any deleted replies.
             */
            @com.google.api.client.util.Key
            private Boolean includeDeleted;
            ...
            /**
             * If set, this will succeed when retrieving a deleted comment, and
             * will include any deleted replies. [default: false]
             */
            public Boolean getIncludeDeleted() {
                return includeDeleted;
            }
         ...
         * @return the request
         */
        public Insert insert(String fileId, com.google.api.services.drive.model.Comment content)
                throws java.io.IOException {
        ...
        public class Insert extends DriveRequest<com.google.api.services.drive.model.Comment> {
             ...
             * @param fileId  The ID of the file.
             * @param content the
             *                {@link com.google.api.services.drive.model.Comment}
             * @since 1.13
             */
        ...
        public class List extends DriveRequest<com.google.api.services.drive.model.CommentList> {
            ...
            protected List(String fileId) {
                super(Drive.this, "GET", REST_PATH, null,
                        com.google.api.services.drive.model.CommentList.class);
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
            }
            ...
            /**
             * If set, all comments and replies, including deleted comments and
             * replies (with content stripped) will be returned.
             */
            @com.google.api.client.util.Key
            private Boolean includeDeleted;
            ...
            /**
             * If set, all comments and replies, including deleted comments and
             * replies (with content stripped) will be returned. [default:
             * false]
             */
            public Boolean getIncludeDeleted() {
                return includeDeleted;
            ...
            /**
             * The maximum number of discussions to include in the response,
             * used for paging. [default: 20] [minimum: 0] [maximum: 100]
             */
            public Integer getMaxResults() {
                return maxResults;
            }
         ...
         * This request holds the parameters needed by the the drive server.
         * After setting any optional parameters, call the
         * {@link Patch#execute()} method to invoke the remote operation.
         *
         * @param fileId    The ID of the file.
         * @param commentId The ID of the comment.
         * @param content   the {@link com.google.api.services.drive.model.Comment}
         * @return the request
         */
        public Patch patch(String fileId, String commentId,
                           com.google.api.services.drive.model.Comment content) throws java.io.IOException {
        ...
        public class Patch extends DriveRequest<com.google.api.services.drive.model.Comment> {
            ...
            /**
             * Updates an existing comment. This method supports patch
             * semantics.
             * <p/>
             * Create a request for the method "comments.patch".
             * <p/>
             ...
             * {@link Patch#execute()} method to invoke the remote operation.
             * <p>
             * {@link Patch#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
             ...
             * @since 1.13
             */
            protected Patch(String fileId, String commentId,
                            com.google.api.services.drive.model.Comment content) {
                super(Drive.this, "PATCH", REST_PATH, content,
                        com.google.api.services.drive.model.Comment.class);
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
                this.commentId = Preconditions.checkNotNull(commentId,
         ...
         * This request holds the parameters needed by the the drive server.
         * After setting any optional parameters, call the
         * {@link Update#execute()} method to invoke the remote operation.
         *
         * @param fileId    The ID of the file.
         * @param commentId The ID of the comment.
         * @param content   the {@link com.google.api.services.drive.model.Comment}
         * @return the request
         */
        public Update update(String fileId, String commentId,
                             com.google.api.services.drive.model.Comment content) throws java.io.IOException {
        ...
        public class Update extends DriveRequest<com.google.api.services.drive.model.Comment> {
             ...
             * {@link Update#execute()} method to invoke the remote operation.
             * <p>
             * {@link Update#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
             ...
             * @since 1.13
             */
            protected Update(String fileId, String commentId,
                             com.google.api.services.drive.model.Comment content) {
                super(Drive.this, "PUT", REST_PATH, content,
                        com.google.api.services.drive.model.Comment.class);
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
                this.commentId = Preconditions.checkNotNull(commentId,
    ...
    public class Files {
         ...
         * This request holds the parameters needed by the the drive server.
         * After setting any optional parameters, call the
         * {@link Copy#execute()} method to invoke the remote operation.
         *
         * @param fileId  The ID of the file to copy.
         * @param content the {@link com.google.api.services.drive.model.File}
         * @return the request
         */
        public Copy copy(String fileId, com.google.api.services.drive.model.File content)
                throws java.io.IOException {
        ...
        public class Copy extends DriveRequest<com.google.api.services.drive.model.File> {
             ...
             * {@link Copy#execute()} method to invoke the remote operation.
             * <p>
             * {@link Copy#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
            ...
            /**
             * Whether to pin the head revision of the new copy. [default:
             * false]
             */
        ...
        public class Get extends DriveRequest<com.google.api.services.drive.model.File> {
            ...
            public boolean isUpdateViewedDate() {
                if (updateViewedDate == null
                        || updateViewedDate == com.google.api.client.util.Data.NULL_BOOLEAN) {
                    return false;
                }
                return updateViewedDate;
            }
         ...
         * </p>
         *
         * @param content      the {@link com.google.api.services.drive.model.File} media
        ...
        public class Insert extends DriveRequest<com.google.api.services.drive.model.File> {
             ...
             *
             * @param content      the {@link com.google.api.services.drive.model.File}
             *                     media metadata or {@code null} if none
             * @param mediaContent The media HTTP content or {@code null} if none.
             * @since 1.13
             */
            protected Insert(com.google.api.services.drive.model.File content,
                             com.google.api.client.http.AbstractInputStreamContent mediaContent) {
                super(Drive.this, "POST", "/upload/" + getServicePath() + REST_PATH, content,
            ...
            public boolean isUseContentAsIndexableText() {
                if (useContentAsIndexableText == null
                        || useContentAsIndexableText == com.google.api.client.util.Data.NULL_BOOLEAN) {
                    return false;
                }
                return useContentAsIndexableText;
            }
            ...
            /**
             * Whether to pin the head revision of the uploaded file. [default:
             * false]
             */
            public Boolean getPinned() {
                return pinned;
         ...
         * @return the request
         */
        public Patch patch(String fileId, com.google.api.services.drive.model.File content)
                throws java.io.IOException {
        ...
        public class Patch extends DriveRequest<com.google.api.services.drive.model.File> {
            ...
            /**
             * Whether to update the view date after successfully updating the
             * file.
             */
            @com.google.api.client.util.Key
            private Boolean updateViewedDate;
            ...
            public boolean isSetModifiedDate() {
                if (setModifiedDate == null
                        || setModifiedDate == com.google.api.client.util.Data.NULL_BOOLEAN) {
                    return false;
                }
                return setModifiedDate;
            }
            ...
            /**
             * Whether a blob upload should create a new revision. If not set or
             * false, the blob data in the current head revision is replaced. If
             * true, a new blob is created as head revision, and previous
             * revisions are preserved (causing increased use of the user's data
             * storage quota).
             */
            @com.google.api.client.util.Key
         ...
         * This request holds the parameters needed by the the drive server.
         * After setting any optional parameters, call the
         * {@link Touch#execute()} method to invoke the remote operation.
         *
         * @param fileId The ID of the file to update.
         * @return the request
         */
        ...
        public class Touch extends DriveRequest<com.google.api.services.drive.model.File> {
             ...
             * {@link Touch#execute()} method to invoke the remote operation.
             * <p>
             * {@link Touch#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
         ...
         * This request holds the parameters needed by the the drive server.
         * After setting any optional parameters, call the
         * {@link Trash#execute()} method to invoke the remote operation.
         *
        ...
        public class Trash extends DriveRequest<com.google.api.services.drive.model.File> {
             ...
             * {@link Trash#execute()} method to invoke the remote operation.
             * <p>
             * {@link Trash#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
         ...
         * This request holds the parameters needed by the the drive server.
         * After setting any optional parameters, call the
         * {@link Untrash#execute()} method to invoke the remote operation.
         *
        ...
        public class Untrash extends DriveRequest<com.google.api.services.drive.model.File> {
             ...
             * {@link Untrash#execute()} method to invoke the remote operation.
             * <p>
             * {@link Untrash#initialize(AbstractGoogleClientRequest)} must be
             * called to initialize this instance immediately after invoking the
             * constructor.
             * </p>
             *
        ...
        public class Update extends DriveRequest<com.google.api.services.drive.model.File> {
            ...
            protected Update(String fileId, com.google.api.services.drive.model.File content,
                             com.google.api.client.http.AbstractInputStreamContent mediaContent) {
                super(Drive.this, "PUT", "/upload/" + getServicePath() + REST_PATH, content,
                        com.google.api.services.drive.model.File.class);
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
                initializeMediaUpload(mediaContent);
    ...
    public class Parents {
        ...
        public class Delete extends DriveRequest<Void> {
            ...
            protected Delete(String fileId, String parentId) {
                ...
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
                this.parentId = Preconditions.checkNotNull(parentId,
                        "Required parameter parentId must be specified.");
            }
         ...
         * @param fileId  The ID of the file.
         * @param content the
         *                {@link com.google.api.services.drive.model.ParentReference}
         * @return the request
         */
        public Insert insert(String fileId, com.google.api.services.drive.model.ParentReference content)
                throws java.io.IOException {
            Insert result = new Insert(fileId, content);
            initialize(result);
            return result;
    ...
    public class Permissions {
        ...
        public class Delete extends DriveRequest<Void> {
            ...
            protected Delete(String fileId, String permissionId) {
                ...
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
                this.permissionId = Preconditions.checkNotNull(permissionId,
                        "Required parameter permissionId must be specified.");
            }
         ...
         * @return the request
         */
        public Insert insert(String fileId, com.google.api.services.drive.model.Permission content)
                throws java.io.IOException {
            Insert result = new Insert(fileId, content);
            initialize(result);
            return result;
        ...
        public class Insert extends DriveRequest<com.google.api.services.drive.model.Permission> {
             ...
             * @param fileId  The ID for the file.
             * @param content the
             *                {@link com.google.api.services.drive.model.Permission}
             * @since 1.13
             */
            ...
            public boolean isSendNotificationEmails() {
                if (sendNotificationEmails == null
                        || sendNotificationEmails == com.google.api.client.util.Data.NULL_BOOLEAN) {
                    return true;
                }
                return sendNotificationEmails;
            }
         ...
         * @return the request
         */
        public Patch patch(String fileId, String permissionId,
                           com.google.api.services.drive.model.Permission content) throws java.io.IOException {
        ...
        public class Patch extends DriveRequest<com.google.api.services.drive.model.Permission> {
             ...
             * @since 1.13
             */
            protected Patch(String fileId, String permissionId,
                            com.google.api.services.drive.model.Permission content) {
                super(Drive.this, "PATCH", REST_PATH, content,
                        com.google.api.services.drive.model.Permission.class);
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
            ...
            /**
             * Whether changing a role to 'owner' should also downgrade the
             * current owners to writers. [default: false]
             */
            ...
            public boolean isTransferOwnership() {
                if (transferOwnership == null
                        || transferOwnership == com.google.api.client.util.Data.NULL_BOOLEAN) {
                    return false;
                }
                return transferOwnership;
            }
         ...
         * @return the request
         */
        public Update update(String fileId, String permissionId,
                             com.google.api.services.drive.model.Permission content) throws java.io.IOException {
        ...
        public class Update extends DriveRequest<com.google.api.services.drive.model.Permission> {
             ...
             * @since 1.13
             */
            protected Update(String fileId, String permissionId,
                             com.google.api.services.drive.model.Permission content) {
                super(Drive.this, "PUT", REST_PATH, content,
                        com.google.api.services.drive.model.Permission.class);
                this.fileId = Preconditions.checkNotNull(fileId,
    ...
    public class Replies {
        ...
        public class Delete extends DriveRequest<Void> {
            ...
            protected Delete(String fileId, String commentId, String replyId) {
                ...
                this.commentId = Preconditions.checkNotNull(commentId,
                        "Required parameter commentId must be specified.");
                this.replyId = Preconditions.checkNotNull(replyId,
                        "Required parameter replyId must be specified.");
            }
         ...
         * @param commentId The ID of the comment.
         * @param content   the
         *                  {@link com.google.api.services.drive.model.CommentReply}
         * @return the request
         */
        public Insert insert(String fileId, String commentId,
                             com.google.api.services.drive.model.CommentReply content) throws java.io.IOException {
        ...
        public class Insert extends DriveRequest<com.google.api.services.drive.model.CommentReply> {
             ...
             * @since 1.13
             */
            protected Insert(String fileId, String commentId,
                             com.google.api.services.drive.model.CommentReply content) {
                super(Drive.this, "POST", REST_PATH, content,
                        com.google.api.services.drive.model.CommentReply.class);
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
        ...
        public class List extends DriveRequest<com.google.api.services.drive.model.CommentReplyList> {
            ...
            protected List(String fileId, String commentId) {
                super(Drive.this, "GET", REST_PATH, null,
                        com.google.api.services.drive.model.CommentReplyList.class);
                this.fileId = Preconditions.checkNotNull(fileId,
                        "Required parameter fileId must be specified.");
                this.commentId = Preconditions.checkNotNull(commentId,
                        "Required parameter commentId must be specified.");
            ...
            /**
             * If set, all replies, including deleted replies (with content
             * stripped) will be returned. [default: false]
             */
            public Boolean getIncludeDeleted() {
                return includeDeleted;
            }
            ...
            /**
             * The maximum number of replies to include in the response, used
             * for paging. [default: 20] [minimum: 0] [maximum: 100]
             */
            public Integer getMaxResults() {
                return maxResults;
            }
         ...
         * @return the request
         */
        public Patch patch(String fileId, String commentId, String replyId,
                           com.google.api.services.drive.model.CommentReply content) throws java.io.IOException {
        ...
        public class Patch extends DriveRequest<com.google.api.services.drive.model.CommentReply> {
             ...
             * @since 1.13
             */
            protected Patch(String fileId, String commentId, String replyId,
                            com.google.api.services.drive.model.CommentReply content) {
                super(Drive.this, "PATCH", REST_PATH, content,
                        com.google.api.services.drive.model.CommentReply.class);
                this.fileId = Preconditions.checkNotNull(fileId,
         ...
         * @return the request
         */
        public Update update(String fileId, String commentId, String replyId,
                             com.google.api.services.drive.model.CommentReply content) throws java.io.IOException {
        ...
        public class Update extends DriveRequest<com.google.api.services.drive.model.CommentReply> {
             ...
             * @since 1.13
             */
            protected Update(String fileId, String commentId, String replyId,
                             com.google.api.services.drive.model.CommentReply content) {
                super(Drive.this, "PUT", REST_PATH, content,
                        com.google.api.services.drive.model.CommentReply.class);
                this.fileId = Preconditions.checkNotNull(fileId,
    ...
    public class Revisions {
        ...
        public class Delete extends DriveRequest<Void> {
            ...
            protected Delete(String fileId, String revisionId) {
                ...
                this.revisionId = Preconditions.checkNotNull(revisionId,
                        "Required parameter revisionId must be specified.");
            }
         ...
         * @return the request
         */
        public Patch patch(String fileId, String revisionId,
                           com.google.api.services.drive.model.Revision content) throws java.io.IOException {
        ...
        public class Patch extends DriveRequest<com.google.api.services.drive.model.Revision> {
             ...
             * @param revisionId The ID for the revision.
             * @param content    the
             *                   {@link com.google.api.services.drive.model.Revision}
             * @since 1.13
             */
            protected Patch(String fileId, String revisionId,
                            com.google.api.services.drive.model.Revision content) {
                super(Drive.this, "PATCH", REST_PATH, content,
         ...
         * @return the request
         */
        public Update update(String fileId, String revisionId,
                             com.google.api.services.drive.model.Revision content) throws java.io.IOException {
        ...
        public class Update extends DriveRequest<com.google.api.services.drive.model.Revision> {
             ...
             * @since 1.13
             */
            protected Update(String fileId, String revisionId,
                             com.google.api.services.drive.model.Revision content) {
                super(Drive.this, "PUT", REST_PATH, content,
                        com.google.api.services.drive.model.Revision.class);
                this.fileId = Preconditions.checkNotNull(fileId,
