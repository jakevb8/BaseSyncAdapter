...
public class DriveDirectoryInfo extends FileInfo implements ICloudFile {
    private File _file;
    private IReadableCloudStorage _cloudStorage;

    public DriveDirectoryInfo(String id, String name, String path, int type, long size, long date,
                              boolean directory) {
